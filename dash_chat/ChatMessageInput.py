...
- value (string; optional):
    ...
    @_explicitize_args
    def __init__(self, onSend=Component.REQUIRED, handleInputChange=Component.REQUIRED, value=Component.UNDEFINED, placeholder=Component.UNDEFINED, buttonLabel=Component.UNDEFINED, customStyles=Component.UNDEFINED, inputComponentStyles=Component.UNDEFINED, **kwargs):
        self._prop_names = ['buttonLabel', 'customStyles', 'inputComponentStyles', 'placeholder', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['buttonLabel', 'customStyles', 'inputComponentStyles', 'placeholder', 'value']
