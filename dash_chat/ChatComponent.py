...
- bubble_styles (dict; default {    user: {        ...sharedBubbleStyle,        backgroundColor: "#007bff",        color: "white",        marginLeft: "auto",        textAlign: "right",    },    assistant: {        ...sharedBubbleStyle,        backgroundColor: "#f1f0f0",        color: "black",        marginRight: "auto",        textAlign: "left",    },}):
...
- typing_indicator (a value equal to: "dots", "spinner"; default "dots"):
    ...
    _type = 'ChatComponent'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, messages=Component.UNDEFINED, theme=Component.UNDEFINED, container_style=Component.UNDEFINED, typing_indicator=Component.UNDEFINED, new_message=Component.UNDEFINED, input_container_style=Component.UNDEFINED, input_text_style=Component.UNDEFINED, fill_height=Component.UNDEFINED, fill_width=Component.UNDEFINED, bubble_styles=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'bubble_styles', 'container_style', 'fill_height', 'fill_width', 'input_container_style', 'input_text_style', 'messages', 'new_message', 'theme', 'typing_indicator']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'bubble_styles', 'container_style', 'fill_height', 'fill_width', 'input_container_style', 'input_text_style', 'messages', 'new_message', 'theme', 'typing_indicator']
