...
- typing_indicator (a value equal to: "dots", "spinner"; default "dots"):
    ...
    _type = 'ChatComponent'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, messages=Component.UNDEFINED, theme=Component.UNDEFINED, custom_styles=Component.UNDEFINED, typing_indicator=Component.UNDEFINED, input_component=Component.UNDEFINED, new_message=Component.UNDEFINED, message_input_container_style=Component.UNDEFINED, message_input_style=Component.UNDEFINED, is_typing=Component.UNDEFINED, fill_height=Component.UNDEFINED, fill_width=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'custom_styles', 'fill_height', 'fill_width', 'input_component', 'is_typing', 'message_input_container_style', 'message_input_style', 'messages', 'new_message', 'theme', 'typing_indicator']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'custom_styles', 'fill_height', 'fill_width', 'input_component', 'is_typing', 'message_input_container_style', 'message_input_style', 'messages', 'new_message', 'theme', 'typing_indicator']
